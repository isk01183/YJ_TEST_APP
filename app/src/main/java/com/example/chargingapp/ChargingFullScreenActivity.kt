...
class ChargingFullScreenActivity : AppCompatActivity() {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.action) {
                ...
                Intent.ACTION_BATTERY_CHANGED -> magicView.updateBattery(intent)
            }
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerReceiver(null, IntentFilter(Intent.ACTION_BATTERY_CHANGED))?.let(magicView::updateBattery)
